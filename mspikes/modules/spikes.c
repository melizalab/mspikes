/* Generated by Cython 0.19.1 on Wed Jul 24 11:09:47 2013 */
...
static int __pyx_pf_7mspikes_7modules_6spikes_13detect_spikes___init__(struct __pyx_obj_7mspikes_7modules_6spikes_detect_spikes *__pyx_v_self, PyObject *__pyx_v_thresh, PyObject *__pyx_v_n_after); /* proto */
static PyObject *__pyx_pf_7mspikes_7modules_6spikes_13detect_spikes_2send(struct __pyx_obj_7mspikes_7modules_6spikes_detect_spikes *__pyx_v_self, PyArrayObject *__pyx_v_samples); /* proto */
...
static char __pyx_k_13[] = "spike detection routines\n\nCopyright (C) 2013 Dan Meliza <dmeliza@gmail.com>\nCreated Wed Jul 24 09:26:36 2013\n";
...
static int __pyx_pw_7mspikes_7modules_6spikes_13detect_spikes_1__init__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("__init__ (wrapper)", 0);
  {
    ...
    __pyx_v_thresh = values[0];
    __pyx_v_n_after = values[1];
  }
...
static int __pyx_pf_7mspikes_7modules_6spikes_13detect_spikes___init__(struct __pyx_obj_7mspikes_7modules_6spikes_detect_spikes *__pyx_v_self, PyObject *__pyx_v_thresh, PyObject *__pyx_v_n_after) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations
 ...
 */
  ...
  __pyx_t_1 = PyObject_RichCompare(__pyx_v_thresh, __pyx_int_0, Py_NE); __Pyx_XGOTREF(__pyx_t_1); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  __pyx_t_3 = __pyx_PyFloat_AsDouble(__pyx_v_thresh); if (unlikely((__pyx_t_3 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 48; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_self->thresh = __pyx_t_3;
 ...
 * 
 */
  __pyx_t_4 = __Pyx_PyInt_AsInt(__pyx_v_n_after); if (unlikely((__pyx_t_4 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 49; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_self->n_after = __pyx_t_4;

  /* "mspikes/modules/spikes.pyx":50
 *         self.thresh = thresh
 *         self.n_after = n_after
 *         self.state = BELOW_THRESHOLD             # <<<<<<<<<<<<<<
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_7mspikes_7modules_6spikes_13detect_spikes_3send(PyObject *__pyx_v_self, PyObject *__pyx_v_samples); /*proto*/
static char __pyx_doc_7mspikes_7modules_6spikes_13detect_spikes_2send[] = "Detect spikes in a time series.\n\n        Returns a list of indices corresponding to the peaks (or troughs) in the\n        data. Retains state between calls. The detector should be reset if there\n        is a gap in the signal.\n\n        ";
static PyObject *__pyx_pw_7mspikes_7modules_6spikes_13detect_spikes_3send(PyObject *__pyx_v_self, PyObject *__pyx_v_samples) {
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_samples), __pyx_ptype_5numpy_ndarray, 0, "samples", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 52; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_r = __pyx_pf_7mspikes_7modules_6spikes_13detect_spikes_2send(((struct __pyx_obj_7mspikes_7modules_6spikes_detect_spikes *)__pyx_v_self), ((PyArrayObject *)__pyx_v_samples));
  goto __pyx_L0;
  __pyx_L1_error:;
  __pyx_r = NULL;
  __pyx_L0:;
...
static PyObject *__pyx_pf_7mspikes_7modules_6spikes_13detect_spikes_2send(struct __pyx_obj_7mspikes_7modules_6spikes_detect_spikes *__pyx_v_self, PyArrayObject *__pyx_v_samples) {
 ...
 */
  __pyx_t_1 = PyArray_IterNew(((PyObject *)__pyx_v_samples)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 64; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __pyx_t_1;
 ...
 */
  while (1) {
    __pyx_t_3 = (PyArray_ITER_NOTDONE(__pyx_v_it) != 0);
    if (!__pyx_t_3) break;

    /* "mspikes/modules/spikes.pyx":66
 *         cdef nx.flatiter it = <nx.flatiter> nx.PyArray_IterNew(samples)
 *         while nx.PyArray_ITER_NOTDONE(it):
 *             x = nx.PyArray_GETITEM(samples, nx.PyArray_ITER_DATA(it))             # <<<<<<<<<<<<<<
 *             if self.state is BELOW_THRESHOLD:
 ...
 */
    __pyx_t_2 = PyArray_GETITEM(__pyx_v_samples, PyArray_ITER_DATA(__pyx_v_it)); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 66; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_XDECREF(__pyx_v_x);
    __pyx_v_x = __pyx_t_2;
    __pyx_t_2 = 0;

    /* "mspikes/modules/spikes.pyx":67
 *         while nx.PyArray_ITER_NOTDONE(it):
 *             x = nx.PyArray_GETITEM(samples, nx.PyArray_ITER_DATA(it))
 *             if self.state is BELOW_THRESHOLD:             # <<<<<<<<<<<<<<
 *                 if compare_sign(x - self.thresh, self.thresh):
 *                     self.prev_val = x
 */
    __pyx_t_3 = ((__pyx_v_self->state == __pyx_e_7mspikes_7modules_6spikes_BELOW_THRESHOLD) != 0);
    if (__pyx_t_3) {

      /* "mspikes/modules/spikes.pyx":68
 *             x = nx.PyArray_GETITEM(samples, nx.PyArray_ITER_DATA(it))
 *             if self.state is BELOW_THRESHOLD:
 *                 if compare_sign(x - self.thresh, self.thresh):             # <<<<<<<<<<<<<<
 *                     self.prev_val = x
 ...
 */
      __pyx_t_2 = PyFloat_FromDouble(__pyx_v_self->thresh); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 68; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_2);
      __pyx_t_1 = PyNumber_Subtract(__pyx_v_x, __pyx_t_2); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 68; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_1);
      ...
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      __pyx_t_3 = (__pyx_f_7mspikes_7modules_6spikes_compare_sign(__pyx_t_4, __pyx_v_self->thresh) != 0);
      if (__pyx_t_3) {

        /* "mspikes/modules/spikes.pyx":69
 *             if self.state is BELOW_THRESHOLD:
 *                 if compare_sign(x - self.thresh, self.thresh):
 *                     self.prev_val = x             # <<<<<<<<<<<<<<
 *                     self.n_after_crossing = 0
 ...
 */
        ...
        __pyx_v_self->prev_val = __pyx_t_4;

        /* "mspikes/modules/spikes.pyx":70
 *                 if compare_sign(x - self.thresh, self.thresh):
 *                     self.prev_val = x
 *                     self.n_after_crossing = 0             # <<<<<<<<<<<<<<
 *                     self.state = BEFORE_PEAK
 ...
 *                     out.append(i - 1)
 */
    __pyx_t_3 = ((__pyx_v_self->state == __pyx_e_7mspikes_7modules_6spikes_BEFORE_PEAK) != 0);
    if (__pyx_t_3) {
 ...
 */
      __pyx_t_1 = PyFloat_FromDouble(__pyx_v_self->prev_val); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 73; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_1);
      __pyx_t_2 = PyNumber_Subtract(__pyx_t_1, __pyx_v_x); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 73; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_2);
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
        __pyx_t_2 = PyInt_FromLong((__pyx_v_i - 1)); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 74; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_2);
        __pyx_t_5 = __Pyx_PyList_Append(__pyx_v_out, __pyx_t_2); if (unlikely(__pyx_t_5 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 74; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

        /* "mspikes/modules/spikes.pyx":75
 *                 if compare_sign(self.prev_val - x, self.thresh):
 *                     out.append(i - 1)
 *                     self.state = AFTER_PEAK             # <<<<<<<<<<<<<<
 *                 elif self.n_after_crossing > self.n_after:
 ...
 *                 else:
 */
      __pyx_t_3 = ((__pyx_v_self->n_after_crossing > __pyx_v_self->n_after) != 0);
      if (__pyx_t_3) {
 ...
 */
        __pyx_t_4 = __pyx_PyFloat_AsDouble(__pyx_v_x); if (unlikely((__pyx_t_4 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 79; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __pyx_v_self->prev_val = __pyx_t_4;
 ...
 *                     self.state = BELOW_THRESHOLD
 */
    __pyx_t_3 = ((__pyx_v_self->state == __pyx_e_7mspikes_7modules_6spikes_AFTER_PEAK) != 0);
    if (__pyx_t_3) {
 ...
 */
      __pyx_t_2 = PyFloat_FromDouble(__pyx_v_self->thresh); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 82; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_2);
      __pyx_t_1 = PyNumber_Subtract(__pyx_t_2, __pyx_v_x); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 82; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_1);
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
...
static PyMethodDef __pyx_methods_7mspikes_7modules_6spikes_detect_spikes[] = {
  {__Pyx_NAMESTR("send"), (PyCFunction)__pyx_pw_7mspikes_7modules_6spikes_13detect_spikes_3send, METH_O, __Pyx_DOCSTR(__pyx_doc_7mspikes_7modules_6spikes_13detect_spikes_2send)},
  {0, 0, 0, 0}
};
...
#endif
{
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("spikes"), __pyx_methods, __Pyx_DOCSTR(__pyx_k_13), 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  /*--- Type init code ---*/
  if (PyType_Ready(&__pyx_type_7mspikes_7modules_6spikes_detect_spikes) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 20; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  #if CYTHON_COMPILING_IN_CPYTHON
  {
    PyObject *wrapper = __Pyx_GetAttrString((PyObject *)&__pyx_type_7mspikes_7modules_6spikes_detect_spikes, "__init__"); if (unlikely(!wrapper)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 20; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  #endif
  if (__Pyx_SetAttrString(__pyx_m, "detect_spikes", (PyObject *)&__pyx_type_7mspikes_7modules_6spikes_detect_spikes) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 20; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
